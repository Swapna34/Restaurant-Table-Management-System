...
export default function EditCustomerDetails() {
    ...
    const init = { fname: "", lname: "", contact: "" };
    ...
    useEffect(() => {
        fetch(`http://localhost:8081/getCustomer/${id}`)
            .then(resp => resp.json())
            .then(data => {
    ...
    const updateData = (data) => {
        ...
        fetch(`http://localhost:8081/updateCustomer/${id}` , {
            method: "PUT",
    ...
    return (
        <div className="container mt-5">
            <div className="card shadow-lg p-4">
                <h2 className="text-center mb-4">Edit Customer Details</h2>
